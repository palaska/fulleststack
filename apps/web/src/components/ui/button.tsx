...
export function Button(
  ...
  if ("to" in props) {
    const linkProps = props as OurButtonProps & LinkProps;
  ...
  const buttonProps = props as OurButtonProps & HeadlessButtonProps;

  return (
    <Headless.Button {...buttonProps} className={clsx(classes, !buttonProps.disabled && "cursor-pointer")}>
      <TouchTarget>{children}</TouchTarget>
    </Headless.Button>
  );
}
