...
export function NavbarDivider({ className, ...props }: React.ComponentProps<"div">) {
...
type BaseNavbarItemProps = { current?: boolean; className?: string; children: React.ReactNode };
...
export function NavbarItem(
  {
    ...
    children,
    ...props
  }: BaseNavbarItemProps & (HeadlessButtonProps | LinkProps),
) {
  const classes = clsx(
    // Base
  ...
  return (
    <span className={clsx(className, "relative")}>
      ...
      {"to" in props
        ? (
            <Link
              {...props as BaseNavbarItemProps & LinkProps}
              className={classes}
        ...
        : (
            <Headless.Button
              {...props as BaseNavbarItemProps & HeadlessButtonProps}
