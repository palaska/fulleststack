...
import { AnimatedView, Pressable, TextInput, View } from "../interop";
...
>(
  (
    ...
    const animatedRef = useAnimatedRef<RNView>();
    ...
    return (
      <AnimatedView className="flex-row items-center" style={rootStyle}>
        <AnimatedView
          style={BORDER_CURVE}
          className={cn(
            "bg-card flex-1 flex-row rounded-lg",
            containerClassName
          )}
        >
          <View
          ...
          >
            <SymbolView
              tintColor={iconColor ?? colors.grey3}
