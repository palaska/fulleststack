...
import { FlashList, View } from "./interop";

type ListDataItem = string | { title: string; subTitle?: string };
type ListVariant = "insets" | "full-width";

type ListRef<T extends ListDataItem> = React.Ref<ShopifyFlashList<T>>;
  ...
  return (
    ...
    >
      <FlashList
        ...
        renderItem={
          renderItemWithVariant(
            renderItem,
            variant,
            data,
            sectionHeaderAsGap
          ) as FlashListRenderItem<unknown>
        }
...
function getItemType(item: ListDataItem) {
...
type ListItemRef = React.Ref<React.ElementRef<typeof View>>;
...
type ListSectionHeaderRef = React.Ref<React.ElementRef<typeof View>>;
